...
def draw(img, ann, img_height, img_width, class_list):
    ...
    x1, y1, x2, y2 = int(ann[0] *
                         img_width), int(ann[1] *
                                         img_height), int(ann[2] *
                                                          img_width), int(ann[3] *
                                                                          img_height)
...
def data_visulization():
    dataset = load_tfrecord_dataset(
        ...
        using_normalizing=using_normalizing,
        priors=priors,
...
if __name__ == '__main__':
    ...
    tfrecord_name = 'Maskdata/train_mask.tfrecord'
